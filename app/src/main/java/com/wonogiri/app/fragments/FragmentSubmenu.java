package com.wonogiri.app.fragments;
...
import com.wonogiri.app.adapters.AdapterSubmenu;
import com.wonogiri.app.listeners.OnTapListener;
import com.wonogiri.app.utils.DBHelperFavorites;
import com.wonogiri.app.utils.DBHelperMenu;
...
public class FragmentSubmenu extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        dbhelperMenu.openDataBase();
        dbhelperFavorites.openDataBase();

        adapterSubmenu = new AdapterSubmenu(getActivity());


        adapterSubmenu.setOnTapListener(new OnTapListener() {
            @Override
    ...
    public class syncGetData extends AsyncTask<Void, Void, Void>{
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            if(recipeIds.isEmpty()) {
                ...
                adapterSubmenu.updateList(recipeIds, recipeNames, cookTimes, servings, images);
            }
    ...
    public void getDataFromDatabase(String key){
        ...
        if(activePage.equals(Utils.ARG_CATEGORY)) {
            data = dbhelperMenu.getAllRecipesData(key);
        }else if(activePage.equals(Utils.ARG_SEARCH)){
            data = dbhelperMenu.getRecipesByName(key);
