...
public class FragmentTambahan extends Fragment {
    ...
    public static FragmentTambahan newInstance(String cookTime, String servings, String summary) {
        FragmentTambahan fragment = new FragmentTambahan();
