...
import com.wonogiri.app.adapters.AdapterDetailPager;
import com.wonogiri.app.fragments.FragmentInfo;
import com.wonogiri.app.fragments.FragmentTambahan;
...
public class ActivityDetail extends ActionBarActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbhelperMenu = new DBHelperMenu(this);
    ...
    public void createPager(){
        pagerFragments.add(FragmentTambahan.newInstance(cookTime, servings, summary));
    ...
    public void getDataFromDatabase(String id){
        ArrayList<Object> row = dbhelperMenu.getRecipeDetail(id);
