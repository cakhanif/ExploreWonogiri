...
import com.wonogiri.app.fragments.FragmentCategories;
...
public class ActivityHome extends ActionBarActivity
        implements FragmentCategories.OnCategorySelectedListener, FragmentSubmenu.OnRecipeSelectedListener {
    ...
    public void onCategorySelected(String ID, String CategoryName) {
        ...
        // Create an instance of FragmentSubmenu
        FragmentSubmenu fragRecipes = (FragmentSubmenu)
        ...
        if (fragRecipes != null) {
            ...
            // adding or replacing the FragmentSubmenu using a
            ...
            // create instance of FragmentSubmenu and give it an argument for the selected article
